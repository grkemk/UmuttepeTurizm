	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Bilet Rezervasyonu Nasıl Yapılır?</h5>
			...
			<div class="modal-body">
				<div class="table-responsive">
					...
					<li>Mevcut seferleri aramak için tarihi seçin ve kalkış ve varış terminalinizi/şehirinizi seçin.
							...
							<li>Yolcunun Adı, Yaşı ve diğer gerekli <b>Müşteri Kimliği</b> gibi müşteri bilgilerini sağlayarak bilet ayrıntılarınızı doldurun. Bununla birlikte, bilet rezervasyonu yapmak için mevcut bankalardan herhangi birini [Ödeme Yöntemi olarak] seçin.</li>
							...
							<li>Ayrıca ödeme doğrulandıktan sonra bir kez <b>E-Bilet</b> alacaksınız. </li>
